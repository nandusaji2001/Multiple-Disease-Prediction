...
diabetes_data = pickle.load(open(r"C:\Users\91974\OneDrive\Desktop\Multiple Disease Prediction Model\Saved Models\diabetes_model_scaler.sav", "rb"))
diabetes_model = diabetes_data['model']
diabetes_scaler = diabetes_data['scaler']

heart_disease_data = pickle.load(open(r"C:\Users\91974\OneDrive\Desktop\Multiple Disease Prediction Model\Saved Models\heart_disease_model_scaler.sav", "rb"))
heart_disease_model = heart_disease_data['model']
heart_disease_scaler = heart_disease_data['scaler']

parkinsons_data = pickle.load(open(r"C:\Users\91974\OneDrive\Desktop\Multiple Disease Prediction Model\Saved Models\parkinsons_model_scaler.sav", "rb"))
...
selected = st.selectbox('Multiple Disease Prediction System',
                        ['Diabetes Prediction',
                         ...
                         'Parkinsons Prediction'],
                        format_func=lambda option: f"{icons[option]} {option}")
